...
// Định nghĩa các navigation items cho sidebar
const NAV_ITEMS = [
        ...
        <aside className="flex flex-col w-64 border-r border-sidebar-border bg-sidebar-background shrink-0">
          ...
          <div className="flex items-center gap-2.5 px-4 h-14 border-b border-sidebar-border">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">Firewall Management</p>
            </div>
          </div>
          ...
          <div className="px-3 py-3">
            ...
            <div className="mt-3 px-3 py-2 rounded-md bg-green-500/10 border border-green-500/20">
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">127.0.0.1:8080</p>
            </div>
          </div>
        </aside>
